...
<body>
	...
	<form
		action="${pageContext.servletContext.contextPath}/checkRoomAvailability"
		method="post">
		<table>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="CheckInMonth"
					value="${CheckInMonth}" /></td>
				<td><input type="text" name="CheckOutDay"
					value="${CheckOutDay}" /></td>
				<td><input type="text" name="CheckOutMonth"
					value="${CheckOutMonth}" /></td>
			</tr>
			<tr>
				<td class="RoomSelection">Room Selection:</td>
				<td class="RoomSelection"><input type="number" name="roomType"
					value="${roomType}" /></td>
			</tr>
		</table>
		<input class="selectButton" type="Submit" name="select"
